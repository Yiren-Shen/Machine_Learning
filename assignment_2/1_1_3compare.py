...
def buildGraph():
    ...
    return W, b, X, X_valid, X_test,y_target, y_valid,  y_test, Lambda, train, y_train_hat, y_valid_hat, y_test_hat,loss_train,loss_valid, loss_test

W, b, X, X_valid, X_test,y_target, y_valid,  y_test, Lambda, train, y_train_hat, y_valid_hat, y_test_hat,loss_train,loss_valid, loss_test = buildGraph()
...
print("Validation Accuracy: %4.2f "%(acc_vaild))
...
plt.plot(validLoss_list, 'g-', linewidth=2.0,label='validLoss_list')
plt.legend()
plt.savefig('113c.png')
plt.subplot(212)
plt.ylabel("accuracy")
plt.plot(trainAcc_list, 'r-', linewidth=2.0,label='trainAcc_list')
plt.plot(testAcc_list, 'b-', linewidth=2.0,label='testAcc_list')
plt.plot(validAcc_list, 'g-', linewidth=2.0,label='validAcc_list')
plt.legend()
plt.savefig('113c2.png')
plt.show()
#
